...
function Page() {
  return (
    <div className="container mx-auto px-4">
      ...
      <div className="mt-3 w-full h-64 bg-slate-800 main flex flex-col justify-center items-center">
        <div className="text-white text-1xl flex mt-5">
          <p className="mx-5 mt-5">96th Academy Awards</p>
          <div className="border h-7 mt-5 mx-5"></div>
          <p className="mt-5">Aired March 10, 2024</p>
        </div>
        <h1 className="text-white text-6xl">OSCARDS</h1>
      </div>

      <h1 className="text-2xl font-serif mt-3">Show Info</h1>
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-4">
        <div>
          <h3 className="font-bold text-lg mt-5">Preshow Hosts:</h3>
          <p className="text-lg">Amelia Dimoldenberg</p>
        </div>
        <div>
          <h3 className="font-bold text-lg mt-5">Produced By:</h3>
          <p className="text-lg">Amelia Dimoldenberg</p>
        </div>
        <div>
          <h3 className="font-bold text-lg mt-5">Directed By:</h3>
          <p className="text-lg">Ranbir Kapoor</p>
        </div>
        <div>
          <h3 className="font-bold text-lg mt-5">Network:</h3>
          <p className="text-lg">ABCD</p>
        </div>
        <div>
          <h3 className="font-bold text-lg mt-5">Network:</h3>
          <p className="text-lg">ABCD</p>
      ...
      <div className="mt-7">
        <h3 className="font-bold text-lg mt-5">Run time:</h3>
        <p className="text-lg">2hr 23min</p>
        <hr className="mt-5" />
      </div>
